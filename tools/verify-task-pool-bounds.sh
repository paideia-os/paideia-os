...
STANDALONE_SLABS = [
    ...
    ("src/kernel/boot/witness/r15_task.pdx", "_fd_witness_task"),
    ("src/kernel/boot/witness/r16_syscalls.pdx", "_sys_open_witness_task"),
    ("src/kernel/boot/witness/r16_syscalls.pdx", "_sys_close_witness_task"),
    ("src/kernel/boot/witness/r16_syscalls.pdx", "_sys_read_witness_task"),
    ("src/kernel/boot/witness/r16_syscalls.pdx", "_sys_write_witness_task"),
    ("src/kernel/boot/witness/r16_syscalls.pdx", "_sys_dup2_witness_task"),
    ("src/kernel/boot/witness/r16_tty.pdx", "_tty_connect_witness_task"),
