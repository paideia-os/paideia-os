...
| **R30** | `r30-acpica-lpss` | ACPICA userspace bubble + AML interpreter + LPSS I²C/GPIO enumeration + EC OpRegion | 40 | R29, R22 (ECAM), R20 (ACPI table walk) | `KIND_FW_SESSION` (renamed from `KIND_AML_SESSION`, #1569), `KIND_OP_REGION`, `KIND_I2C_BUS`, `KIND_I2C_SLAVE`, `KIND_GPIO_LINE` |
